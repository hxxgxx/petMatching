...
<div class="container">
	...
	<div class="container">
		...
		<p class="text-danger">
		  ...
		  <em id="listcount" class="text-danger">받은 메시지 수 : ${receiveMessageCount} </em>
		</p>
...
<div class="sesarch">
    ...
    <div class="input-group">
      ...
      <div class="search">
	      <input name="search_word" type="text" class="form-control"
              placeholder="보낸이의 id를 입력하세요." value="${search_word}" style="border:1px solid #dc3545; height:30px">
      </div>&nbsp;
  ...
  <c:if test="${receiveMessageCount >0}"> 
    ...
    <span class="date"><b>받은 날짜</b></span><span class="read">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;<b>읽음여부</b></span><hr class="text-danger">
    <c:forEach var="r" items="${receiveMessageList}">
      ...
      <span class="sender" style="color:black;">${r.sender_id}</span><span class="title" style="color:black;">${r.message_title}</span><span class="date" style="color:black;">${r.register_date}</span>
