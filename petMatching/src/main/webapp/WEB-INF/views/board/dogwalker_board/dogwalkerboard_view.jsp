...
<script>
	...
	function messagePopUp() {
		...
		window.open(
				"${pageContext.request.contextPath}/message/send?receiver_id="
						+ receiver, "post",
...
body>div.container>div:nth-child(6)>img {
	width: 300px
}
...
body>div.container>div:nth-child(6)>textarea {
	padding: 0;
	margin-top: 2em;
	margin-bottom: 5em;
}
	...
	<div class="container">
		...
		<div class="container">
				...
				<div style="padding-right: 0px">
					<c:if test="${!empty boarddata.BOARD_FILE}">
						<img class="demo cursor"
							src="${pageContext.request.contextPath}/resources/dwboard_upload${boarddata.BOARD_FILE}" style="width:200px; height:200px; margin-top:3em;">
					</c:if>
					<c:if test="${empty boarddata.BOARD_FILE}">
					</c:if>
					<textarea class="form-control" 
					style="padding: 0; margin-top: 2em; margin-bottom: 3em; border:none; background-color:white; resize:none;"
					readOnly> ${boarddata.BOARD_CONTENT}</textarea>
				</div>
			</c:if>
			...
			<button id="send" class="btn btn-info" onClick="messagePopUp()">
				<img id="image1"
					src="${pageContext.request.contextPath}/resources/image/reply_message.png"
					alt="메시지  보내기" width="30px"> 메시지 보내기
			</button>
			...
			<div class="center">
				...
				<c:if
					test="${boarddata.BOARD_NAME == loginid || loginid == 'admin' }">
					...
					<div class="modal-dialog">
						<div class="modal-content">
							...
							<div class="modal-body">
								<form id="form_delete" name="deleteForm" action="delete"
									method="post">
				...
				<div id="comment">
					<button class="btn btn-info float-left"
						style="background-color: #dc3545; border-color: #dc3545">총
						50자 까지 가능합니다.</button>
					...
					<table class="table table_striped">
						<thead>
							<tr>
								<td id="commenthead" style="border-top: none">아이디</td>
								<td id="commenthead" style="border-top: none">내용</td>
								<td id="commenthead" style="border-top: none">날짜</td>
							</tr>
						</thead>
						<tbody>
