...
<c:if test = "${listcount == 0 && !empty search_word }">
	...
	<a href = "list">
		...
		<button type="button" onclick="location.href='/dw_board/write'" class = "btn btn-info float-right" style="background-color:#dc3545; border-color:#dc3545">글 쓰 기</button>
</div>
</body>
</html>
