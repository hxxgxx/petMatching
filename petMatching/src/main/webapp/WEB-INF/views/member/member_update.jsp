...
<div class="container text-danger">
		<div class="container-wrapper">
			...
			<form action="updateProcess" method="post">
				...
				<input class="form-control" type="text" name="id" id="id" value="${memberinfo.id }" readonly>
				...
				<input class="form-control" type="text" name="name" id="name" value="${memberinfo.name }" required>
				
				
				<label for="phone">핸드폰 번호* [예) 010-1234-5678]</label> <span id = "message4"></span>
				<input class="form-control"	type="text" name="phone" id="phone" value="${memberinfo.phone }" required>
